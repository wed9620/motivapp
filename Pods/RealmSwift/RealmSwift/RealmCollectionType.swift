...
public protocol RealmCollectionType: Collection, CustomStringConvertible {
    ...
    */
    ...
    /// :nodoc:
    func _addNotificationBlock(_ block: (AnyRealmCollection<Element>?, NSError?) -> ()) -> NotificationToken
}
...
private class _AnyRealmCollectionBase<T: Object>: RealmCollectionType {
    ...
    func makeIterator() -> RLMGenerator<T> { fatalError() }
...
private final class _AnyRealmCollection<C: RealmCollectionType>: _AnyRealmCollectionBase<C.Element> {
    ...
    */
    ...
    override func makeIterator() -> RLMGenerator<Element> {
        // FIXME: it should be possible to avoid this force-casting
    ...
    */
    ...
    /// :nodoc:
    override func _addNotificationBlock(_ block: (AnyRealmCollection<Element>?, NSError?) -> ()) -> NotificationToken {
...
public final class AnyRealmCollection<T: Object>: RealmCollectionType {
    ...
    */
    ...
    public func makeIterator() -> RLMGenerator<T> { return base.makeIterator() }
    ...
    */
    ...
    public func addNotificationBlock(_ block: (AnyRealmCollection<Element>?, NSError?) -> ()) -> NotificationToken {
        return base._addNotificationBlock(block)
    }

    /// :nodoc:
    public func _addNotificationBlock(_ block: (AnyRealmCollection<Element>?, NSError?) -> ()) -> NotificationToken {
        return base._addNotificationBlock(block)
    }
}
